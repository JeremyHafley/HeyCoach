...
import 'talks_details_model.dart';
export 'talks_details_model.dart';

class TalksDetailsWidget extends StatefulWidget {
  const TalksDetailsWidget({super.key});

  @override
  State<TalksDetailsWidget> createState() => _TalksDetailsWidgetState();
}

class _TalksDetailsWidgetState extends State<TalksDetailsWidget> {
  late TalksDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TalksDetailsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'TalksDetails'});
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Text(
                                    'Welcome to \"Overcome Personal Issues,\" the talk where we explore practical strategies and inspiring stories to help you tackle life\'s challenges head-on. Each episode features expert advice, personal anecdotes, and actionable tips to empower you on your journey towards personal growth and resilience. Tune in and take the first step towards overcoming your personal obstacles today!',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Manrope',
